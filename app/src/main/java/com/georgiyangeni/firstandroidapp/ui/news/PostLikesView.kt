...
import com.georgiyangeni.firstandroidapp.util.dpToPx
import com.georgiyangeni.firstandroidapp.util.getCompatColor
import com.georgiyangeni.firstandroidapp.util.inflate
...
class PostLikesView @JvmOverloads constructor(
    ...
    var colors: List<Int> = listOf(Color.LTGRAY)
        .flatMap { listOf(it, it, it, it, it, it) } // 5
